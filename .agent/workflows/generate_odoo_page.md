...
1.  **MANDATORY**: You **MUST** read `d:/gemini/odoo/docs/ODOO_DYNAMIC_RULES.md`.
...
1.  **Reference**: `d:/gemini/odoo/docs/ODOO_RULES_AI.md` (Core Design) & `d:/gemini/odoo/docs/ODOO_LAYOUT_RULES.md`.
...
-   **YES**: You **MUST** read `d:/gemini/odoo/docs/ODOO_BUTTON_STYLES.md`.
