...
1.  **MANDATORY**: You **MUST** read `d:/gemini/icbAi/docs/ODOO_DYNAMIC_RULES.md`.
...
1.  **Reference**: `d:/gemini/icbAi/docs/ODOO_RULES_AI.md` (Core Design) & `d:/gemini/icbAi/docs/ODOO_LAYOUT_RULES.md`.
...
-   **YES**: You **MUST** read `d:/gemini/icbAi/docs/ODOO_BUTTON_STYLES.md`.
