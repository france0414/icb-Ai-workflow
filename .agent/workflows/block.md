...
## 1. 讀取區塊知識庫
// turbo-all
**MUST** 讀取 `d:/gemini/odoo/.agent/skills/icb_page_generator/resources/layout_patterns.md`
**MUST** 讀取 `d:/gemini/odoo/.agent/skills/icb_page_generator/resources/custom_blocks.md`
